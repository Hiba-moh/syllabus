...
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| In this exercise we will extend our `Logo` component to log to the console when clicking on the image. <DemoWrapper showConsole><ExerciseADemo /></DemoWrapper> |
...
| 5. Create the `catchPokemon` function and update the `caught` state so that it is increased by 1 on each click. <details><summary>Click here if you are stuck.</summary>You will need to call the set state function (the 2nd item in the `useState` array) with `caught + 1`.</details>                                                                                                      |
